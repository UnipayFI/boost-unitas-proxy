...
/**
 * @title StakedUSDu
 * @notice The StakedUSDu contract allows users to stake USDu tokens and earn a portion of protocol LST and perpetual yield that is allocated
 ...
 */
contract StakedUSDu is SingleAdminAccessControl, ReentrancyGuard, ERC20Permit, ERC4626, IStakedUSDu {
  ...
  /**
   * @notice Constructor for StakedUSDu contract.
   ...
   * Note that the owner cannot rescue USDu tokens because they functionally sit here
   * and belong to stakers but can rescue staked USDu as they should never actually
  ...
  /**
   * @notice Returns the amount of USDu tokens that are vested in the contract.
   */
  ...
  /**
   * @notice Returns the amount of USDu tokens that are unvested in the contract.
   */
